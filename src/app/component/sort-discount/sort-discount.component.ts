...
@Component({
  selector: 'app-sort-discount',
  templateUrl: './sort-discount.component.html',
  styleUrls: ['./sort-discount.component.css']
})
export class SortDiscountComponent implements OnInit {
